...
data_Subject_Dir = mypath + 'data_EEG/'
stimDict_path = mypath + 'WORDS/data_stimdict/'
data_preproc_path = mypath + 'WORDS/data_preproc/'
data_epochs_path = mypath + 'WORDS/data_epochs/'
data_evoked_path = mypath + 'WORDS/data_evoked/'
plot_topo_path = mypath + 'WORDS/plots/Topomap/'
plot_erp_path = mypath + 'WORDS/plots/ERP/'
plot_stats_path = mypath + 'WORDS/plots/stats/'
data_stats_path = mypath + 'WORDS/stats/'
text_stats_path = mypath + 'WORDS/stats/'
cleaning_path = mypath + 'WORDS/plots/cleaning/'
data_grandaverage_path = mypath + 'WORDS/data_grandaverage/'
plot_grandaverage_path = mypath + 'WORDS/plots/grandaverage/'
plot_GFP_path = mypath + 'WORDS/plots/GFP/'

data_evoked_group_path = mypath + 'WORDS/data_evoked_group/'
plot_evoked_group_path = mypath + 'WORDS/plots/evoked_group/'
...
nameStimDict = mypath + 'WORDS/data_stimdict/'
...
csv_stats_textfile = mypath + 'WORDS/stats/SpatTempTstats_GrandAverage.csv'
